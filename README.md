...
A beautiful, customizable link-in-bio page with a built-in dashboard for managing links, tracking analytics, and customizing your theme. Built with Next.js, Tailwind CSS, and Neon Postgres.
...
3. **Add Neon Postgres** — Vercel auto-provisions a free Neon database and injects `DATABASE_URL` for you. No separate Neon account, no connection strings to copy.
...
# Create tables + seed starter data in Neon
npm run db:seed
